...
import { h as useStore, l as supabase, r as Field, t as Action, u as syncFromCloud } from "./store-BUFgMFPj.mjs";
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: "Firdous"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "bg-space size-[5px] rounded-full" })]
				}),
				...
				account ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(mode === "signin" || mode === "register") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
							label: "Password",
							type: "password",
							value: password,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						"magic",
						"reset"
					].filter((m) => m !== mode).map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => {
							setMode(m);
							setSent(false);
						...
						children: m === "signin" ? "Sign in" : m === "register" ? "Create account" : m === "magic" ? "Magic link" : "Forgot password"
					}, m))
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: ["Continue as guest →", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-muted-foreground mt-1 block text-xs leading-relaxed",
						children: "Everything stays on this device. Nothing is sent anywhere until you decide."
					})]
				})
			]
		})
