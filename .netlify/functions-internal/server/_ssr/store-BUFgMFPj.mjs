...
function Section({ eyebrow, title, aside, children, className = "" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [(eyebrow || title || aside) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			className: "mb-4 flex items-end justify-between gap-4",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [eyebrow && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: eyebrow }), title && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: tabs.map((t) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [t.label, active && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "bg-space absolute inset-x-3.5 -bottom-px h-[2px] rounded-full" })]
				}, t.id);
			})
		})
	});
...
function Action({ children, onClick, variant = "quiet", type = "button", className = "", disabled, ariaLabel }) {
	const styles = {
		quiet: "border border-border bg-card text-foreground hover:border-space/60 hover:bg-space-soft/40",
...
function Tick({ done, onToggle, label }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [burst && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "border-space pulse-ring absolute inset-0 rounded-full border" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
			viewBox: "0 0 24 24",
			className: "size-3.5",
			fill: "none",
...
function Sheet({ open, onClose, title, children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "bg-rule mx-auto mb-5 h-1 w-9 rounded-full sm:hidden" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var supabase = createClient("https://wmyrpejbgnvmokiccgpx.supabase.co", "sb_publishable_NpJFewrEUlFs1XOnzKxXwA_vRYCsM-3");
...
function writeStore(key, value) {
	...
	supabase.auth.getSession().then(({ data: { session } }) => {
		if (session?.user) supabase.from("user_data").upsert({
...
//#endregion
export { Section as a, Tick as c, todayKey as d, uid as f, useStore as h, Meter as i, supabase as l, useOnline as m, EmptyState as n, Sheet as o, useNow as p, Field as r, SubTabs as s, Action as t, syncFromCloud as u };
