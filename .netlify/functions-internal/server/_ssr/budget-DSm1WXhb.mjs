...
import { a as Section, d as todayKey, f as uid, h as useStore, i as Meter, n as EmptyState, r as Field, s as SubTabs, t as Action } from "./store-BUFgMFPj.mjs";
...
var money = (n) => new Intl.NumberFormat("en-IN", { maximumFractionDigits: 0 }).format(Math.round(n));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
			...
			children: recent.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
				...
				children: recent.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: cap ? `of ₹${money(cap)} planned · ₹${money(Math.max(0, cap - total))} left` : "No monthly limit set yet"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-5",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Meter, { value: cap ? total / cap * 100 : 0 })
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
			eyebrow: "Where it went",
			title: "Categories",
			children: [byCategory.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
				glyph: "◦",
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: [
								"₹",
								money(amt),
								limit ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "text-ink-faint",
									children: [" / ", money(limit)]
								}) : null
							]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Meter, { value: limit ? amt / limit * 100 : total ? amt / total * 100 : 0 })] }, cat);
				})
...
function Zakat() {
	...
	const net = (Number(v.cash) || 0) + (Number(v.gold) || 0) + (Number(v.business) || 0) - (Number(v.debts) || 0);
	const nisab = 65e3;
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: net >= nisab ? "Your wealth is above the nisab threshold for a full lunar year." : `Below the nisab estimate of ₹${money(nisab)} — no zakat is due on this amount.`
				})
			]
		})]
	});
