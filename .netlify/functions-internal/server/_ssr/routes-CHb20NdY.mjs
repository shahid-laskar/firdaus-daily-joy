...
var LISTS = ["General", "Shopping", "Work", "Home"];
function Tasks() {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className: "bg-rule mx-1 h-4 w-px",
          }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
            ...
            className:
              "border-border/80 numeric h-[42px] rounded-xl border bg-transparent px-2.5 text-sm",
          }),
                ...
                "li",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                      ...
                      className:
                        "text-ink-faint hover:text-destructive text-xs opacity-0 transition group-hover:opacity-100 focus-visible:opacity-100",
                      children: "Remove",
                    }),
                  ],
                },
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("datalist", {
            ...
            children: recipes.map((r) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: r.name }, r.id),
            ),
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                ...
                children: [remaining, " of ", items.length, " still to pick up"],
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("form", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
          ...
          className:
            "text-ink-faint placeholder:text-ink-faint focus:text-foreground w-full bg-transparent text-sm outline-none",
        }),
      }),
    ],
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
        ...
        placeholder:
          "The family scratchpad — codes, reminders, the thing you'll forget by evening.",
        rows: 14,
        className:
          "focus:border-space/60 w-full resize-none rounded-2xl border border-transparent bg-[linear-gradient(transparent_calc(2rem_-_1px),var(--rule)_calc(2rem_-_1px))] bg-[size:100%_2rem] p-4 text-[0.95rem] leading-8 outline-none",
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function Today() {
  ...
  const dinner =
    meals[`${["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"][now?.getDay() ?? 1]}-Dinner`];
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
            ...
            children: [greeting(hour), profile.name ? `, ${profile.name}` : "", "."],
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
            ...
            children:
              open.length === 0 && todayEvents.length === 0
                ...
                : `${open.length} thing${open.length === 1 ? "" : "s"} waiting${todayEvents.length ? ` · ${todayEvents.length} on the calendar` : ""}.`,
          }),
        ],
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
