...
import { a as Section, c as Tick, d as todayKey, f as uid, h as useStore, i as Meter, n as EmptyState, r as Field, s as SubTabs, t as Action } from "./store-BUFgMFPj.mjs";
...
function Habits() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
		...
		}), habits.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
			glyph: "❋",
			headline: "No habits yet",
			body: "Start with one small thing you'd like to repeat. Streaks build themselves."
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			className: "space-y-7",
			children: habits.map((h) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: week.map((d) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						"aria-pressed": on,
						onClick: () => setHabits(habits.map((x) => x.id === h.id ? {
							...x,
...
function Journal() {
	...
	const past = Object.entries(entries).filter(([d]) => d !== todayKey()).sort((a, b) => b[0].localeCompare(a[0]));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-10",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
		...
		}), past.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
			eyebrow: "Earlier",
			title: "Entries",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
				className: "thread",
				children: past.map(([date, entry]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: "flex gap-1.5",
					children: [...Array(8)].map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			}), workouts.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
				glyph: "◇",
				headline: "Nothing logged",
				body: "Record a walk, a set, a swim — whatever counts as moving today."
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
				className: "thread",
				children: workouts.map((x) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					className: "thread-node py-3",
...
function Cycle() {
	...
	const next = data.last ? new Date(new Date(data.last).getTime() + data.length * 864e5).toISOString().slice(0, 10) : "";
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: daysAway !== null && daysAway >= 0 ? `${daysAway} days away` : "Overdue — this is often normal."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-5",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Meter, { value: daysAway !== null ? Math.max(0, 100 - daysAway / data.length * 100) : 0 })
				})
			]
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mt-8",
