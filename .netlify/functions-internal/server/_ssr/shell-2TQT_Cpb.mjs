      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            onClick: toggleMode,
            className:
              "rounded-md border border-border bg-card px-2.5 py-1 text-xs font-medium text-foreground transition-colors hover:bg-muted",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                  className:
                    "text-ink-faint flex items-center gap-1.5 rounded-full px-2 py-1 text-[0.7rem]",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
        ...
        className:
          "fixed inset-x-0 bottom-0 z-30 flex justify-center pb-[max(0.75rem,env(safe-area-inset-bottom))]",
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "border-border/70 bg-background/90 flex gap-1 rounded-full border p-1.5 shadow-[var(--shadow-float)] backdrop-blur-xl",
          children: SPACES.map((s) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              Link,
              {
                ...
                className:
                  "press relative flex min-w-[68px] flex-col items-center gap-0.5 rounded-full px-3 py-1.5",
                style: active
                  ? {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
              ...
              children:
                "Everything you write lives on this device first. When you're online it quietly syncs — nothing is ever lost while you wait.",
            }),
          ],
        }),
      }),
