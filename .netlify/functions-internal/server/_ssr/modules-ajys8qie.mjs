...
import {
  i as Madhab,
  n as CalculationMethod,
  r as Coordinates,
  t as PrayerTimes,
} from "../_libs/adhan.mjs";
...
function usePrayers(date = /* @__PURE__ */ new Date()) {
  ...
  return (0, import_react.useMemo)(() => {
    ...
    let params = CalculationMethod[pMethod]
      ? CalculationMethod[pMethod]()
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
        ...
        children: [count, " of 5 logged today · ", countdown?.next.time ?? "—"],
      }),
      isFriday &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
var PHRASES = ["SubhanAllah", "Alhamdulillah", "Allahu Akbar", "Astaghfirullah"];
var TARGETS = [33, 100, 1e3];
function Tasbih() {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "text-ink-faint mr-2 inline-grid size-7 place-items-center rounded-full border border-[var(--rule)] align-middle text-[0.7rem]",
                        children: a.n,
                      }),
                    ],
                  }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    dir: "ltr",
                    className:
                      "mt-3 flex gap-3 opacity-0 transition group-hover:opacity-100 focus-within:opacity-100",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        onClick: () =>
                          setBookmarks(
        ...
        children: days.map((d) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              className:
                "press numeric grid aspect-square place-items-center rounded-lg border text-[0.68rem]",
              style: {
                background:
                  s === "obligatory"
                    ? "var(--space-accent)"
