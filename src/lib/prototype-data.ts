...
export function seedPrototypeData(force = false) {
  ...
  seedKey("tasks", [
    { id: uid(), title: "Pay the electricity bill", list: "Home", time: "17:00", done: false, date: todayKey() },
    { id: uid(), title: "Call Umma", list: "General", done: false, date: todayKey() },
    { id: uid(), title: "Take out the bins", list: "Home", done: false, date: todayKey(), recur: rec("daily", -30), completions: [iso(-1), iso(-2)] },
    { id: uid(), title: "Water the plants", list: "Home", done: false, date: todayKey(), recur: rec("weekly", -21), completions: [iso(-7)] },
    { id: uid(), title: "Review the month's spending", list: "General", done: false, date: iso(2), recur: rec("monthly", -60), completions: [] },
  ...
  seedKey("recipes", [
    { id: uid(), name: "Kozhi curry", items: "chicken, onions, coconut milk, curry leaves, ginger" },
  ...
  seedKey("events", [
    ...
    { id: uid(), title: "Maghrib walk with Ammu", date: todayKey(), time: "18:45", recur: rec("daily", -10) },
    { id: uid(), title: "Jumu'ah at Palayam", date: iso(((5 - new Date().getDay() + 7) % 7) || 7), time: "12:45", recur: rec("weekly", -7) },
  ...
  seedKey("kids", [
    {
      ...
      age: "9",
      chores: [
        { id: uid(), title: "Make the bed", done: false, recur: rec("daily", -30), completions: [iso(-1), iso(-2), iso(-3)] },
        { id: uid(), title: "Quran — 10 minutes", done: false, recur: rec("daily", -30), completions: [iso(-1), iso(-3)] },
        { id: uid(), title: "Tidy the study table", done: false, recur: rec("weekly", -28), completions: [iso(-7)] },
      ],
    },
    {
      id: uid(),
      ...
      age: "6",
      chores: [
        { id: uid(), title: "Put away toys", done: false, recur: rec("daily", -20), completions: [iso(-1)] },
        { id: uid(), title: "Feed the fish", done: false, recur: rec("daily", -20), completions: [iso(-1), iso(-2)] },
      ],
    },
  ]);

  seedKey("deeds", [
    { id: uid(), who: "Fatima", what: "Shared her snack with Yusuf without being asked", date: iso(-1) },
  ...
  seedKey("reminders", [
    ...
    { id: uid(), title: "Surah Al-Kahf", time: "07:00", recur: rec("weekly", ((5 - new Date().getDay() + 7) % 7) - 7) },
  ]);
