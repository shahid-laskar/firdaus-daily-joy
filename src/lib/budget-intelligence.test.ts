...
describe("Budget Intelligence", () => {
  ...
  test("generateBudgetInsights - positive/negative trend", () => {
    const insightsDown = generateBudgetInsights(
      calculateBudgetAnalytics([...expenses, { id: "9", amount: 10000, category: "Other", date: "2026-07-01" }], "2026-08", 10),
      {}
    );
    ...
    const insightsUp = generateBudgetInsights(
      calculateBudgetAnalytics([...expenses, { id: "10", amount: 10000, category: "Other", date: "2026-08-01" }], "2026-08", 10),
      {}
    );
